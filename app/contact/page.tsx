            ...
            <div className="space-y-6">
              <Card className="p-6 flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">support@bugsymat.shop</p>
                  <p className="text-muted-foreground">info@bugsymat.shop</p>
                </div>
              </Card>
              ...
              <Card className="p-6 flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">+234 8162592760</p>
                </div>
              </Card>
